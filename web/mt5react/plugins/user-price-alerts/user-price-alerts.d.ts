...
export interface ShowHoverData {
	/** Text is used for the hover box */
	text: string;
	showHover: true;
	hoverRemove: boolean;
}
export interface NoHoverData {
	showHover: false;
}
export interface AlertRendererDataBase {
	y: number;
	showHover: boolean;
	text?: string;
}
export interface CrosshairButtonData {
	hoverColor: string;
...
declare class UserAlertsState {
	private _alertAdded;
	private _alertRemoved;
	private _alertChanged;
	private _alertsChanged;
	private _alerts;
	constructor();
	destroy(): void;
	...
	_updateAlertsArray(): void;
	private _getNewId;
}
export declare class UserPriceAlerts extends UserAlertsState implements ISeriesPrimitive<Time> {
	private _chart;
	private _series;
	private _mouseHandlers;
	private _paneViews;
	private _pricePaneViews;
	private _lastMouseUpdate;
